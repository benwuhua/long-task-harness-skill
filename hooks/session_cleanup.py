#!/usr/bin/env python3
"""
SessionStart / SessionEnd Hook: Session Cleanup  (long-task packaged plugin, plugin-level)
...
Fires automatically for every session where the packaged long-task plugin is installed.
